...
class ZJResearchFourVc: ZJMainVc,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource {
    
    var models: [DDPolifitsResearch]?
...
//        loadData()
    ...
    func createUI() {
        ...
        self.collection?.registerClass(CHCultureCell.self, forCellWithReuseIdentifier: "four_Cell")
...
//        self.collection!.registerNib(nib, forCellWithReuseIdentifier: "DDCultureCollectionViewCell")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("four_Cell", forIndexPath: indexPath) as! CHCultureCell
...
extension ZJResearchFourVc {
    //MARK: - 请求数据
    private func loadData(method: Int) {
        
        DDPolifitsResearch.loadHomeData { (result) in
