...
//        loadData()
    ...
    func createUI() {
        ...
        self.collection?.registerClass(CHCultureCell.self, forCellWithReuseIdentifier: "seven_Cell")
...
//        self.collection!.registerNib(nib, forCellWithReuseIdentifier: "DDCultureCollectionViewCell")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("seven_Cell", forIndexPath: indexPath) as! CHCultureCell
