...
import UIKit
  ...
  class ZJWorkFiveVc: ZJMainVc,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource {
...
//        loadData()
    ...
    func createUI() {
        ...
        self.collection?.registerClass(CHCultureCell.self, forCellWithReuseIdentifier: "five_Cell")
...
//        self.collection!.registerNib(nib, forCellWithReuseIdentifier: "DDCultureCollectionViewCell")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("five_Cell", forIndexPath: indexPath) as! CHCultureCell
  ...
  extension ZJWorkFiveVc {
    //MARK: - 请求数据
    private func loadData(method: Int) {
        
        DDPoliticsWorkModel.loadHomeData { (result) in
