...
class ZJLibrarySixVc: ZJMainVc,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource {
    
    var models: [DDCommitteCase]?
...
//        loadData()
    ...
    func createUI() {
        ...
        self.collection?.registerClass(CHCultureCell.self, forCellWithReuseIdentifier: "six_cell")
...
//        self.collection!.registerNib(nib, forCellWithReuseIdentifier: "DDCultureCollectionViewCell")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("six_cell", forIndexPath: indexPath) as! CHCultureCell
...
extension ZJLibrarySixVc {
    //MARK: - 请求数据
    private func loadData(method: Int) {
        
        DDCommitteCase.loadHomeData { (result) in
