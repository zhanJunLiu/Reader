...
class ZJLearnOneVc: ZJMainVc,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource {
    ...
    func createUI() {
        ...
        self.collection?.registerClass(CHCultureCell.self, forCellWithReuseIdentifier: "DDCultureCollectionViewCell")
...
//        self.collection!.registerNib(nib, forCellWithReuseIdentifier: "DDCultureCollectionViewCell")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("DDCultureCollectionViewCell", forIndexPath: indexPath) as! CHCultureCell
...
extension ZJLearnOneVc {
    //MARK: - 请求数据
    private func loadData(method: Int) {
        
        DDLearnDataModel.loadHomeData { (result) in
