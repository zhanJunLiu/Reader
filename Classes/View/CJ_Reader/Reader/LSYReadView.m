...
-(void)menuNote:(id)sender
{
    ...
    UIAlertAction *confirm = [UIAlertAction actionWithTitle:@"确认" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        NSDictionary *dict = @{@"note_description":[_content substringWithRange:_selectRange], @"note_date":[NSDate date]};
        [self getData:dict];
        ...
        [defaults setObject:model.content forKey:@"content"];
        [defaults setObject:model.note forKey:@"note"];
...
- (void)getData:(NSDictionary *)paramters {
    ...
    [mgr POST:@"http://192.168.31.48/index.php/myStackroom/AddmyNotes" parameters:paramters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSLog(@"成功的发送");
